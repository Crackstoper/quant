...
class OffsetConverter:
    ...
    def update_position(self, position: PositionData) -> None:
        ...
        holding: Optional[PositionHolding] = self.get_position_holding(position.vt_symbol)
        if holding:
    ...
    def update_trade(self, trade: TradeData) -> None:
        ...
        holding: Optional[PositionHolding] = self.get_position_holding(trade.vt_symbol)
        if holding:
    ...
    def update_order(self, order: OrderData) -> None:
        ...
        holding: Optional[PositionHolding] = self.get_position_holding(order.vt_symbol)
        if holding:
    ...
    def update_order_request(self, req: OrderRequest, vt_orderid: str) -> None:
        ...
        holding: Optional[PositionHolding] = self.get_position_holding(req.vt_symbol)
        if holding:
            holding.update_order_request(req, vt_orderid)

    def get_position_holding(self, vt_symbol: str) -> Optional[PositionHolding]:
        """"""
        holding: Optional[PositionHolding] = self.holdings.get(vt_symbol, None)
